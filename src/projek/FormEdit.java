    ...
    private void btn_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hapusActionPerformed
        try {
            ...
            if ((jawab = JOptionPane.showConfirmDialog(null, "Ingin Menghapus Data Ini?", "Yes", JOptionPane.YES_NO_OPTION)) == 0) {
                ...
                st.executeUpdate("DELETE FROM crud WHERE id_pasien='" + txt_id_pasien.getText() + "'");
            }
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateActionPerformed
        try {
            ...
            if (input_nama.getText() == "") {
                ...
                rs = st.executeQuery("SELECT * FROM crud WHERE nik = " + input_nik.getText() + " AND NOT id_pasien = " + txt_id_pasien.getText() + "");
                if (rs.next()) {
                    JOptionPane.showMessageDialog(null, "NIK : '" + input_nik.getText() + "' sudah terpakai!");
                    input_nik.setText("");
                } else {
                    st.executeUpdate("UPDATE crud SET nama = '" + input_nama.getText() + "', nik = '" + input_nik.getText() + "', alamat = '" + input_alamat.getText() + "', tgl_lahir = '" + new SimpleDateFormat("yyyy-MM-dd").format(input_tgl_lahir.getDate()) + "' WHERE id_pasien = '" + txt_id_pasien.getText() + "'");
